...
BABA_TEMPLATES = [
    "Then, [B] and [A] went to the [PLACE]. [A] was given a [OBJECT] by [B]",
    "Then, [B] and [A] had a lot of fun at the [PLACE]. [A] was given a [OBJECT] by [B]",
    "Then, [B] and [A] were working at the [PLACE]. [A] was given a [OBJECT] by [B]",
    "Then, [B] and [A] were thinking about going to the [PLACE]. [A] was offered a [OBJECT] by [B]",
    "Then, [B] and [A] had a long argument, and afterwards [A] was told by [B]",
    "After [B] and [A] went to the [PLACE], [A] was given a [OBJECT] by [B]",
    "When [B] and [A] got a [OBJECT] at the [PLACE], [A] was given the [OBJECT] by [B]",
    "While [B] and [A] were working at the [PLACE], [A] was given the [OBJECT] by [B]",
    "While [B] and [A] were commuting to the [PLACE], [A] was given a [OBJECT] by [B]",
    "After the lunch, [B] and [A] went to the [PLACE]. [A] was given a [OBJECT] by [B]",
    "Afterwards, [B] and [A] went to the [PLACE]. [A] was given a [OBJECT] by [B]",
    "The [PLACE] [B] and [A] went to had a [OBJECT]. [A] was given [OBJECT] by [B]",
    "Friends [B] and [A] found a [OBJECT] at the [PLACE]. [A] was given [OBJECT] by [B]",
]



BABA_LONG_TEMPLATES = [
    "Then in the morning, [B] and [A] went to the [PLACE]. [A] was given a [OBJECT] by [B]",
    "Then in the morning, [B] and [A] had a lot of fun at the [PLACE]. [A] was given a [OBJECT] by [B]",
    "Then in the morning, [B] and [A] were working at the [PLACE]. [A] was given a [OBJECT] by [B]",
    "Then in the morning, [B] and [A] were thinking about going to the [PLACE]. [A] was offered a [OBJECT] by [B]",
    "Then in the morning, [B] and [A] had a long argument, and afterwards [A] was told by [B]",
    "After taking a long break [B] and [A] went to the [PLACE], [A] was given a [OBJECT] by [B]",
    "When soon afterwards [B] and [A] got a [OBJECT] at the [PLACE], [A] was given the [OBJECT] by [B]",
    "When soon afterwards [B] and [A] got a [OBJECT] at the [PLACE], [A] was given the [OBJECT] by [B]",
    "While spending time together [B] and [A] were working at the [PLACE], [A] was given a [OBJECT] by [B]",
    "While spending time together [B] and [A] were commuting to the [PLACE], [A] was given a [OBJECT] by [B]",
    "After the lunch in the afternoon, [B] and [A] went to the [PLACE]. [A] was given a [OBJECT] by [B]",
    "Afterwards, while spending time together [B] and [A] went to the [PLACE]. [A] was given a [OBJECT] by [B]",
    "Then in the morning afterwards, [B] and [A] had a long argument. Afterwards [A] was told by [B]",
    "The local big [PLACE] [B] and [A] went to had a [OBJECT]. [A] was given [OBJECT] by [B]",
    "Friends separated at birth [B] and [A] found a [OBJECT] at the [PLACE]. [A] was given [OBJECT] by [B]",
]
...
BABA_LATE_IOS = [
    ...
    "Then, [B] and [A] were working at the [PLACE]. [A] was given a [OBJECT] by [B]",
    "Then, [B] and [A] were thinking about going to the [PLACE]. [A] was offered a [OBJECT] by [B]",
    "Then, [B] and [A] had a long argument and after that [A] was told by [B]",
    "After the lunch, [B] and [A] went to the [PLACE]. [A] was given a [OBJECT] as a gift by [B]",
    "Afterwards, [B] and [A] went to the [PLACE]. [A] was given a [OBJECT] by [B]",
    "Then, [B] and [A] had a long argument. Afterwards [A] was told by [B]",
]


BABA_EARLY_IOS = [
    "Then [B] and [A] went to the [PLACE], and [A] was given a [OBJECT] by [B]",
    "Then [B] and [A] had a lot of fun at the [PLACE], and [A] was given a [OBJECT] as a gift by [B]",
    "Then [B] and [A] were working at the [PLACE], and [A] was given a [OBJECT] by [B]",
    "Then [B] and [A] were thinking about going to the [PLACE], and [A] was given a [OBJECT] by [B]",
    "Then [B] and [A] had a long argument, and after that [A] was told by [B]",
    "After the lunch [B] and [A] went to the [PLACE], and [A] was given a [OBJECT] by [B]",
    "Afterwards [B] and [A] went to the [PLACE], and [A] was given a [OBJECT] by [B]",
    "Then [B] and [A] had a long argument, and afterwards [A] was told by [B]",
]
        ...
        if flip[0] == "S2":
            if flip[1] == "IO":
                ...
                while rand_name == prompt["IO"] or rand_name == prompt["S"]:
                    rand_name = names[np.random.randint(len(names))]
                # pdb.set_trace()
                t[len(t) - t[::-1].index(prompt["IO"]) - 1] = rand_name
            else:
