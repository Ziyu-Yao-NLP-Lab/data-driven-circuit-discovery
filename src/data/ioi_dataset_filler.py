...
FOUR_ABC_TEMPLATES = [
    "Then, [A], [B], [C], and [D] went to the [PLACE]. [B], [C], and [D] gave a [OBJECT] to [A]",
    "Then, [A], [B], [C], and [D] had a lot of fun at the [PLACE]. [B], [C], and [D] gave a [OBJECT] to [A]",
    "Then, [A], [B], [C], and [D] were working at the [PLACE]. [A], [B], and [C] decided to give a [OBJECT] to [D]",
    "Then, [A], [B], [C], and [D] were thinking about going to the [PLACE]. [B], [C], and [D] wanted to give a [OBJECT] to [A]",
    "Then, [A], [B], [C], and [D] had a long argument, and afterwards [A], [C], and [D] said to [B]",

]

FIVE_ABC_TEMPLATES = [
    "Then, [A], [B], [C], [D], and [E] went to the [PLACE]. [B], [C], [D], and [E] gave a [OBJECT] to [A]",
    "Then, [A], [B], [C], [D], and [E] had a lot of fun at the [PLACE]. [B], [C], [D], and [E] gave a [OBJECT] to [A]",
    "Then, [A], [B], [C], [D], and [E] were working at the [PLACE]. [A], [B], [C], and [D] decided to give a [OBJECT] to [E]",
    "Then, [A], [B], [C], [D], and [E] were thinking about going to the [PLACE]. [B], [C], [D], and [E] wanted to give a [OBJECT] to [A]",
    "Then, [A], [B], [C], [D], and [E] had a long argument, and afterwards [A], [C], [D], and [E] said to [B]",
]
...
BABA_TEMPLATES = [
    "Then, [B] and [A] went to the [PLACE]. [A] had always wanted to go to the [PLACE]. [B] gave a [OBJECT] to [A]",
    "Then, [B] and [A] had a lot of fun at the [PLACE]. [A] had always wanted to go to the [PLACE]. [B] gave a [OBJECT] to [A]",
    "Then, [B] and [A] were working at the [PLACE]. [A] was talking about [OBJECT]. [B] decided to give a [OBJECT] to [A]",
    "Then, [B] and [A] were thinking about going to the [PLACE]. [A] had always wanted to got the [PLACE]. [B] wanted to give a [OBJECT] to [A]",
    "Then, [B] and [A] had a long argument, [A] was talking loud, and afterwards [B] said to [A]",
    "After [B] and [A] went to the [PLACE], [A] had always wanted to go to the [PLACE]. [B] gave a [OBJECT] to [A]",
    "When [B] and [A] got a [OBJECT] at the [PLACE], [B] wanted to make [A] happy and [B] decided to give it to [A]",
    "When [B] and [A] got a [OBJECT] at the [PLACE], [B] wanted to make [A] happy and [B] decided to give the [OBJECT] to [A]",
    "While [B] and [A] were working at the [PLACE], [A] was surpised when [B] gave a [OBJECT] to [A]",
    "While [B] and [A] were commuting to the [PLACE], [A] was pleased when [B] gave a [OBJECT] to [A]",
    "After the lunch, [B] and [A] went to the [PLACE]. [A] was talking about [OBJECT]. [B] gave a [OBJECT] to [A]",
    "Afterwards, [B] and [A] went to the [PLACE]. [A] was talking about [OBJECT]. [B] gave a [OBJECT] to [A]",
    "Then, [B] and [A] had a long argument. [A] was talking about [OBJECT].Afterwards [B] said to [A]",
    "The [PLACE] [B] and [A] went to had a [OBJECT]. To make [A] happy, [B] gave it to [A]",
    "Friends [B] and [A] found a [OBJECT] at the [PLACE]. To make [A] happy,[B] gave it to [A]",
]

BABA_LONG_TEMPLATES = [
    "Then in the morning, [B] and [A] went to the [PLACE]. [A] was happy when [B] gave a [OBJECT] to [A]",
    "Then in the morning, [B] and [A] had a lot of fun at the [PLACE]. [A] was surprised when [B] gave a [OBJECT] to [A]",
    "Then in the morning, [B] and [A] were working at the [PLACE]. [A] was talking about [OBJECT]. [B] decided to give a [OBJECT] to [A]",
    "Then in the morning, [B] and [A] were thinking about going to the [PLACE]. To make [A] happy, [B] wanted to give a [OBJECT] to [A]",
    "Then in the morning, [B] and [A] had a long argument, [A] eventually fell silent, and afterwards [B] said to [A]",
    "After taking a long break [B] and [A] went to the [PLACE], [A] was happy when [B] gave a [OBJECT] to [A]",
    "When soon afterwards [B] and [A] got a [OBJECT] at the [PLACE], to make [A] happy, [B] decided to give it to [A]",
    "When soon afterwards [B] and [A] got a [OBJECT] at the [PLACE], to make [A] happy, [B] decided to give the [OBJECT] to [A]",
    "While spending time together [B] and [A] were working at the [PLACE], [A] was surpised when [B] gave a [OBJECT] to [A]",
    "While spending time together [B] and [A] were commuting to the [PLACE], [A] was surpised when [B] gave a [OBJECT] to [A]",
    "After the lunch in the afternoon, [B] and [A] went to the [PLACE]. [A] was talking about [OBJECT]. [B] gave a [OBJECT] to [A]",
    "Afterwards, while spending time together [B] and [A] went to the [PLACE]. [A] was looking for [OBJECT]. [B] gave a [OBJECT] to [A]",
    "Then in the morning afterwards, [B] and [A] had a long argument. [A] eventually fell silent. Afterwards [B] said to [A]",
    "The local big [PLACE] [B] and [A] went to had a [OBJECT]. [A] really liked the [OBJECT]. [B] gave it to [A]",
    "Friends separated at birth [B] and [A] found a [OBJECT] at the [PLACE]. To make [A] happy, [B] gave it to [A]",
]

BABA_LATE_IOS = [
    "Then, [B] and [A] went to the [PLACE]. [A] was looking for [OBJECT]. [B] gave a [OBJECT] to [A]",
    "Then, [B] and [A] had a lot of fun at the [PLACE]. To make [A] happy, [B] gave a [OBJECT] to [A]",
    "Then, [B] and [A] were working at the [PLACE]. To surprise [A], [B] decided to give a [OBJECT] to [A]",
    "Then, [B] and [A] were thinking about going to the [PLACE]. [A] was looking for [OBJECT]. [B] wanted to give a [OBJECT] to [A]",
    "Then, [B] and [A] had a long argument, [A] eventually fell silent and after that [B] said to [A]",
    "After the lunch, [B] and [A] went to the [PLACE]. To surprise [A], [B] gave a [OBJECT] to [A]",
    "Afterwards, [B] and [A] went to the [PLACE]. To surprise [A], [B] gave a [OBJECT] to [A]",
    "Then, [B] and [A] had a long argument. [A] was very unhappy. Afterwards [B] said to [A]",
]


BABA_EARLY_IOS = [
    "Then [B] and [A] went to the [PLACE], and [A] was surprised when [B] gave a [OBJECT] to [A]",
    "Then [B] and [A] had a lot of fun at the [PLACE], and to celebrate [A]’s special day, [B] gave a [OBJECT] to [A]",
    "Then [B] and [A] were working at the [PLACE], and to make [A] happy, [B] decided to give a [OBJECT] to [A]",
    "Then [B] and [A] were thinking about going to the [PLACE], and for [A]’s special day, [B] wanted to give a [OBJECT] to [A]",
    "Then [B] and [A] had a long argument, [A] eventually fell silent and after that [B] said to [A]",
    "After the lunch [B] and [A] went to the [PLACE], and to surprise [A], [B] gave a [OBJECT] to [A]",
    "Afterwards [B] and [A] went to the [PLACE], and to surprise [A], [B] gave a [OBJECT] to [A]",
    "Then [B] and [A] had a long argument, [A] eventually fell silent and afterwards [B] said to [A]",
]
...
def gen_prompt_uniform(
    templates, names, nouns_dict, N, symmetric, prefixes=None, abc=False, four_abc=True
):
    nb_gen = 0
    ioi_prompts = []
    while nb_gen < N:
        ...
        if four_abc:
            prompt1 = prompt1.replace("[D]", name_4)
...
class IOIDataset:
    def __init__(
        ...
        elif prompt_type == "FOUR_ABC":
            self.templates = FOUR_ABC_TEMPLATES[:nb_templates].copy()
        ...
        if prompts is None:
            self.ioi_prompts = gen_prompt_uniform(  # a list of dict of the form {"text": "Alice and Bob bla bla. Bob gave bla to Alice", "IO": "Alice", "S": "Bob"}
                ...
                four_abc=(prompt_type in ["FOUR_ABC"]),
            )
        else:
