...
NEW_BABA_TEMPLATES = [
    "Then, [B] and [A] went to the [PLACE]. To celebrate [A]’s special day, [B] gave a [OBJECT] to [A]",
    "Then, [B] and [A] had a lot of fun at the [PLACE]. To celebrate [A]’s special day, [B] gave a [OBJECT] to [A]",
    "Then, [B] and [A] were working at the [PLACE]. [A] was talking about [OBJECT]. [B] decided to give a [OBJECT] to [A]",
    "Then, [B] and [A] were thinking about going to the [PLACE]. To celebrate [A]’s special day, [B] wanted to give a [OBJECT] to [A]",
    "Then, [B] and [A] had a long argument, [A] eventually fell silent, and afterwards [B] said to [A]",
    "After [B] and [A] went to the [PLACE], [A] was surprised when [B] gave a [OBJECT] to [A]",
    ...
    for prompt in prompts:
        ...
        if flip[0] == "S2":
            if flip[1] == "IO":
                ...
                select_letter = prompt["S"].split(" ")[-1]
                t[len(t) - t[::-1].index(select_letter) - 1] = rand_name.split()[-1]
            else:
